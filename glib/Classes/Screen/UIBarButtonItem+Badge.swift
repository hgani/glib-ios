//// See https://gist.github.com/freedom27/c709923b163e26405f62b799437243f4
//import UIKit
//
...
//    }
//
//    func setBadge(text: String?, withOffsetFromTopRight offset: CGPoint = CGPoint.zero, andColor color: UIColor = UIColor.red, andFilled filled: Bool = true, andFontSize _: CGFloat = 11) {
//        badgeLayer?.removeFromSuperlayer()
//
//        if text == nil || text! == "" || Int(text!) == 0 {
//            return
//        }
//
